...
function CardPrice({ ChainID, basicsymbol, dex, pairadress, title, basetoken, quotetoken, priceusd, pricenative }) {
  return (
    <DIV>
      <div>
        <div><h1 className='title'>{title}</h1></div>
         <div className='parent'> <p>Price Native -</p><p> {pricenative}</p> </div>
         <div className='parent'> <p>Price USD -</p><p> {priceusd}</p> </div> 
      </div>
